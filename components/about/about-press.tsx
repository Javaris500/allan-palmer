            ...
            >
              ...
              >
                <div className="flex items-baseline justify-between gap-6 mb-3">
                  <span className="label-caps !text-[10px] !tracking-[0.3em] text-champagne/85">
                    {m.publication}
                  </span>
                  <span className="label-caps !text-[10px] !tracking-[0.22em] !text-muted-foreground/65 shrink-0">
                    {m.date}
                  </span>
                </div>
                <h3 className="font-display italic font-light text-xl md:text-2xl text-foreground/90 group-hover:text-champagne tracking-tight leading-snug transition-colors duration-500 ease-cinematic">
                  &ldquo;{m.headline}&rdquo;
                </h3>
                <span
                  aria-hidden="true"
                  className="mt-4 inline-flex items-center gap-2 text-link !text-[11px] !tracking-[0.25em] text-muted-foreground group-hover:text-champagne"
                >
                  Read article
